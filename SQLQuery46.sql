...
--A query that returns the top ten highest Invoices for using the LIMIT function
SELECT TOP 10 * FROM Invoices ORDER BY InvoiceTotal DESC
--takes all values and orders them by InvoiceTotal descending and only takes the top 10
...
98	83	31361833	2016-03-21 00:00:00	579.42	0.00	0.00	2	2016-04-10 00:00:00	NULL	0.00
...
110	80	134116	2016-03-28 00:00:00	90.36	0.00	0.00	2	2016-04-17 00:00:00	NULL	0.00
